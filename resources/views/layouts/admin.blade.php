    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white {{ Request::is('product') ? 'active bg-gradient-primary' : '' }}"
                        href="{{ url('product') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">receipt_long</i>
                        </div>
            ...
            <span class="nav-link-text ms-1">Sign In</span>
                ...
                <li class="nav-item">
                  <a class="nav-link text-white {{ Request::is('OrderDetails') ? 'active bg-gradient-primary' : '' }} " href="{{url('OrderDetails')}}">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                          <i class="material-icons opacity-10">person</i>
                      </div>
              ...
              <li class="nav-item">
                  <a class="nav-link text-white {{ Request::is('UserDetails') ? 'active bg-gradient-primary' : '' }} " href="{{url('UserDetails')}}">
                      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                          <i class="material-icons opacity-10">person</i>
                      </div>
                      <span class="nav-link-text ms-1">Users Details</span>
                  </a>
              </li>
            </ul>
        </div>
